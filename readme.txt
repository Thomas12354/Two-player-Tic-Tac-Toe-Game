...
2.First,open the Server.java and run the Server.java. "Server is running..." will be printed in console.

3.Then, open the Player.java and run the Player.java. Please dont submit player name before opening both player windows.
...
4.Again, pressing the run button to run Player.java in eclipse. 
...
5.Enter the player 1 name. After submitting player 1 name, enter player 2 name and submit. The game can be played afterthen. 
